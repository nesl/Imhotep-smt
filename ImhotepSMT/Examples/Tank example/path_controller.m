function [set_point_linear, set_point_rotation, end_sim] = path_controller(linear_state, rotation_state)
...
points = [5,        5,      10,         10,   15,   15, 20 , 20];
angles = [0,     pi/2,      pi/2,       pi, pi,   1.5*pi/2, 1.5*pi, 1.5*pi];
